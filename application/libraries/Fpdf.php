...
function vcell($c_width,$c_height,$x_axis,$text){
	...
	if($len>($c_width/2)){
		$w_text=str_split($text,($c_width/2));// splits the text into length of 7 and saves in a array since we need wrap cell of two cell we took $w_text[0], $w_text[1] alone.
