      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Version</b> <?php echo Property::$software_version; ?>
        </div>
        <strong>Copyright &copy; 2014-2015 <a href="<?php echo Property::$developer_site; ?>"><?php echo Property::$developer; ?></a>.</strong> All rights reserved.
      </footer>
    ...
    <?php
    if(is_array($footer_script) || !empty($footer_script)) {
    	echo $footer_script;
    }
    ?>
  </body>
